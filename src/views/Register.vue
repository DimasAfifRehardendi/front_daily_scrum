                ...
                <form class="pt-3" v-on:submit.prevent="Register">
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <input type="password" class="form-control form-control-lg border-left-0" name="password_confirmation" id="password_confirmation" placeholder="Retype Your New Password"  v-model="password_confirmation" required>                        
                    </div>
                  </div>
                  <div class="my-3">
